...
# Task 4 - Object Detection using Guided text  
################################################# 
 
task_prompt4  = "<CAPTION_TO_PHRASE_GROUNDING>"
results = run_florence2(task_prompt4 , image, text_input="parrot")
...
cv2.imwrite("Best-Object-Detection-models/Florence-2/Image captioningUsing Florence-2/Step3_OD_Phrased_result.png", open_cv_image)
