...
label_names=["Maccabi player", "Real Madrid player", "ball", "referee"]
...
images_path = 'C:/Data-sets/Mac-Real/dataset/train/images'
label_folder = 'C:/Data-sets/Mac-Real/dataset/train/labels'
