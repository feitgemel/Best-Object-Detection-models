# How to build Object Detection Heatmap video ? | Yolo V8
<p align="center">
  <img width="800" src="How to build Object Detection Heatmap video.png" "image">
</p>
...
<font size= "4" >
An object detection heatmap is a visual representation used to highlight areas within an image where an object detection model has identified the presence of objects

In this video, we will generate heatmaps using object detection and object tracking . The tutorial is based on YoloV8
<br/>

You can find the link for the [tutorial](https://youtu.be/ldf6ZACHIsI) here. 
